...
def insert_electricity_distribution_grid(
    ...
    bevs = n.links.index[n.links.carrier.str.contains(f"BEV charger ({segment_pattern})")]
...
def get_car_efficiencies():
    ...
    for engine in engine_types:
        car_efficiencies.loc[engine, "pkw"] = options[f"transport_{engine}_efficiency"]["pkw"]
